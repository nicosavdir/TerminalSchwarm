...
def changepixel1d(x,brightness,img):
    if x != None:
        if img == 1:
            ...
            shadebal1[pixels[x]]-=1;
            shadebal1[brightness]+=1;
            return pixels
        elif img == 2:
...
def balanceshade(shade):
    ...
    if shadebal1[shade]<shadebal2[shade]:
        changepixel1d(searchshade(pixels,shade,False),shade,1)
        return False
    elif shadebal1[shade]>shadebal2[shade]:
        changepixel1d(searchshade(pixels,shade,True),shade+1,1)
        return False
    else:
        return True
